...
//   svgDetails; // the IconAsSvg's work this way but LinkAsSvg is showing linkDestination? as an optional prop even though I've set it to required prop on LinkAsSvg.tsx
